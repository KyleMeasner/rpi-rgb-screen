...
func (s *WeatherForecastDayScreen) Render() (image.Image, bool) {
	...
	s.Ctx.SetColor(color.RGBA{0x87, 0x87, 0x87, 85}) // #878787
	...
	s.Ctx.SetColor(color.RGBA{0xB0, 0xB0, 0xB0, 85}) // #B0B0B0
	...
	s.Ctx.SetColor(color.RGBA{0xE3, 0xE3, 0xE3, 85}) // #E3E3E3
